...
S="${WORKDIR}/BinauralPlayer-1.6.31"
...
SRC_URI="https://github.com/alamahant/BinauralPlayer/archive/refs/tags/v1.6.31.tar.gz -> ${P}.tar.gz"
...
project(BinauralPlayer VERSION 1.6.31 LANGUAGES CXX)
...
set(PROJECT_SOURCES
    ...
    resources.qrc
    radionicsconsole.cpp radionicsconsole.h
)
