...
S="${WORKDIR}/BinauralPlayer-1.6.2"
...
SRC_URI="https://github.com/alamahant/BinauralPlayer/archive/refs/tags/v1.6.2.tar.gz -> ${P}.tar.gz"
...
project(BinauralPlayer VERSION 1.6.2 LANGUAGES CXX)
