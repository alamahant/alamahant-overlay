...
S="${WORKDIR}/BinauralPlayer-1.6.1"
...
SRC_URI="https://github.com/alamahant/BinauralPlayer/archive/refs/tags/v1.6.1.tar.gz -> ${P}.tar.gz"
...
project(BinauralPlayer VERSION 1.6.1 LANGUAGES CXX)
