...
S="${WORKDIR}/BinauralPlayer-1.5.0"
...
SRC_URI="https://github.com/alamahant/BinauralPlayer/archive/refs/tags/v1.5.0.tar.gz -> ${P}.tar.gz"
...
project(BinauralPlayer VERSION 1.5.0 LANGUAGES CXX)
