...
EAPI=8
inherit cmake
S="${WORKDIR}/Ermis-1.1.3"

DESCRIPTION="Ermis - Multi-format Steganography Tool (Qt6)"
HOMEPAGE="https://github.com/alamahant/Ermis"
SRC_URI="https://github.com/alamahant/Ermis/archive/refs/tags/v1.1.3.tar.gz -> ${P}.tar.gz"
...
project(Ermis VERSION 1.1.3 LANGUAGES CXX)
